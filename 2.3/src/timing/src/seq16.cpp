...
{
  public:
    MinimalPublisher(): Node("Seq"), elapsed_time(0)
    {
      publisher_ = this->create_publisher<std_msgs::msg::String>("ping", 10, std::bind(&Seq::ping, this, _1));
      timer_ = this->create_wall_timer(1ms, std::bind(&Seq::timer_callback, this));
